USE [BARRACHINA_DB]
GO
/****** Object:  Table [dbo].[Direcciones]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  Table [dbo].[MotivosDevolucion]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Impuestos]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[FormasPago]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[DetalleCompras]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Descuentos]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[CuentaCorrientes]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[CuentaCorrientes] ([CodigoCuentaCorriente], [Saldo], [LimiteCuenta], [Estado]) VALUES (1, CAST(1300 AS Decimal(18, 0)), CAST(5000 AS Decimal(18, 0)), 1)
...
/****** Object:  Table [dbo].[Contactos]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[CondicionesIVA]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Compras]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[TipoProductos]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Proveedores]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Ventas]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Ventas] ([NumeroVenta], [Usuario], [Cliente], [Fecha], [Total], [MetodoPago]) VALUES (1, 0, 0, CAST(0xC73F0B00 AS Date), CAST(30.00 AS Decimal(18, 2)), N'Efectivo')
INSERT [dbo].[Ventas] ([NumeroVenta], [Usuario], [Cliente], [Fecha], [Total], [MetodoPago]) VALUES (3, 0, 2, CAST(0xC73F0B00 AS Date), CAST(30.80 AS Decimal(18, 2)), N'Efectivo')
INSERT [dbo].[Ventas] ([NumeroVenta], [Usuario], [Cliente], [Fecha], [Total], [MetodoPago]) VALUES (4, 0, 2, CAST(0xC73F0B00 AS Date), CAST(15.40 AS Decimal(18, 2)), N'Efectivo')
SET IDENTITY_INSERT [dbo].[Ventas] OFF
/****** Object:  Table [dbo].[Usuarios]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Usuarios] ([CodigoUsuario], [Nombre], [Sector], [Constrasenia], [Estado]) VALUES (1, N'Alejandra', N'Administracion', N'1234', 1)
INSERT [dbo].[Usuarios] ([CodigoUsuario], [Nombre], [Sector], [Constrasenia], [Estado]) VALUES (2, N'Federico', N'Ventas', N'4321', 1)
INSERT [dbo].[Usuarios] ([CodigoUsuario], [Nombre], [Sector], [Constrasenia], [Estado]) VALUES (3, N'Pedro', N'Ventas', N'1111', 1)
/****** Object:  Table [dbo].[Rubros]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[SP_CargarDetallaCompra]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProveedorXImpuesto]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Productos]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'1', N'10', N'Beldent chicle globo', 4, 3, 40, CAST(5 AS Decimal(18, 0)), CAST(3 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'10', N'1000', N'Coca Cola x600 ml', 3, 48, 48, CAST(25 AS Decimal(18, 0)), CAST(30 AS Decimal(18, 0)), CAST(50 AS Decimal(18, 0)), CAST(40 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 12, 200, 2, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'2', N'20', N'Beldent', 4, 0, 100, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'3', N'30', N'Beldent tutti-fruttiss', 4, 2, 60, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'4', N'40', N'Beldent mix', 4, 4, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'5', N'50', N'Beldent frutilla', 4, 4, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 200, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'6', N'60', N'Beldent mento turbo', 3, 2, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 200, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'7', N'70', N'Beldent menta fuerte', 4, 5, 60, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 200, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'7790580222109', N'779', N'Beldent menta', 4, 20, 60, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'8', N'80', N'Beldent mentol', 4, 0, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 200, 1, 1)
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [NombreProducto], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [Rentabilidad], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (N'9', N'90', N'Beldent citrus', 4, 0, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(20 AS Decimal(18, 0)), CAST(15 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), 20, 100, 1, 1)
/****** Object:  Table [dbo].[Clientes]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Empleados]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[DetalleVentas]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[DetalleVentas] ([NumeroFactura], [NumeroLinea], [CodigoProducto], [Cantidad], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista]) VALUES (1, 2, N'1', 1, CAST(0.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(18, 2)), CAST(10.00 AS Decimal(18, 2)), CAST(8.00 AS Decimal(18, 2)))
INSERT [dbo].[DetalleVentas] ([NumeroFactura], [NumeroLinea], [CodigoProducto], [Cantidad], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista]) VALUES (1, 3, N'1', 1, CAST(0.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(18, 2)), CAST(10.00 AS Decimal(18, 2)), CAST(8.00 AS Decimal(18, 2)))
INSERT [dbo].[DetalleVentas] ([NumeroFactura], [NumeroLinea], [CodigoProducto], [Cantidad], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista]) VALUES (2, 1, N'1', 1, CAST(0.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(18, 2)), CAST(20.00 AS Decimal(18, 2)), CAST(15.00 AS Decimal(18, 2)))
INSERT [dbo].[DetalleVentas] ([NumeroFactura], [NumeroLinea], [CodigoProducto], [Cantidad], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista]) VALUES (2, 2, N'4', 1, CAST(0.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(18, 2)), CAST(20.00 AS Decimal(18, 2)), CAST(15.00 AS Decimal(18, 2)))
INSERT [dbo].[DetalleVentas] ([NumeroFactura], [NumeroLinea], [CodigoProducto], [Cantidad], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista]) VALUES (3, 1, N'1', 1, CAST(0.00 AS Decimal(18, 2)), CAST(0.00 AS Decimal(18, 2)), CAST(20.00 AS Decimal(18, 2)), CAST(15.00 AS Decimal(18, 2)))
/****** Object:  StoredProcedure [dbo].[SP_EliminarProducto]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [TR_BAJASTOCK]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_CargarDetallaVenta]    Script Date: 06/17/2019 22:18:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_CargarDetallaVenta]
...
GO
/****** Object:  ForeignKey [FK_Empleados_Usuarios]    Script Date: 06/17/2019 22:18:36 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_Rubros]    Script Date: 06/17/2019 22:18:36 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_TipoProductos]    Script Date: 06/17/2019 22:18:36 ******/
...
GO
/****** Object:  ForeignKey [FK_ProveedorXImpuesto_Impuestos]    Script Date: 06/17/2019 22:18:36 ******/
