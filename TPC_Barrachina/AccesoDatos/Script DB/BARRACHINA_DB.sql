USE [BARRACHINA_DB]
GO
/****** Object:  Table [dbo].[MotivosDevolucion]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Impuestos]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[FormasPago]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Direcciones]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Descuentos]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[CuentaCorrientes]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[TipoProductos]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Sectores]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Rubros]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[CondicionesIVA]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Usuarios]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Contactos]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[PersonaJuridicas]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[PersonaJuridicas](
	[CodigoPersonaJuridica] [int] NOT NULL,
	[RazonSocial] [varchar](50) NOT NULL,
	[NumeroCUIT] [varchar](20) NOT NULL,
	[NombreFantasia] [varchar](30) NOT NULL,
	[CodigoContacto] [int] NOT NULL,
 CONSTRAINT [PK_PersonaJuridicas] PRIMARY KEY CLUSTERED 
(
	[CodigoPersonaJuridica] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
SET ANSI_PADDING OFF
GO
INSERT [dbo].[PersonaJuridicas] ([CodigoPersonaJuridica], [RazonSocial], [NumeroCUIT], [NombreFantasia], [CodigoContacto]) VALUES (1, N'Maria Alejandra Barrachina', N'27-34521771-7', N'Joaco', 2)
INSERT [dbo].[PersonaJuridicas] ([CodigoPersonaJuridica], [RazonSocial], [NumeroCUIT], [NombreFantasia], [CodigoContacto]) VALUES (2, N'Marina Julia Mansilla', N'27-14523578-7', N'Kisco San Fernando', 1)
INSERT [dbo].[PersonaJuridicas] ([CodigoPersonaJuridica], [RazonSocial], [NumeroCUIT], [NombreFantasia], [CodigoContacto]) VALUES (3, N'Piantoni', N'30-53685465-4', N'Piantoni', 3)
/****** Object:  Table [dbo].[PersonaFisicas]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[PersonaFisicas](
	[CodigoPersonaFisica] [int] NOT NULL,
	[Nombre] [varchar](30) NOT NULL,
	[Apellido] [varchar](30) NOT NULL,
	[FechaNacimiento] [datetime] NOT NULL,
	[Sexo] [nchar](10) NOT NULL,
	[CodigoContacto] [int] NOT NULL,
 CONSTRAINT [PK_PersonaFisicas_1] PRIMARY KEY CLUSTERED 
(
	[CodigoPersonaFisica] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
SET ANSI_PADDING OFF
GO
INSERT [dbo].[PersonaFisicas] ([CodigoPersonaFisica], [Nombre], [Apellido], [FechaNacimiento], [Sexo], [CodigoContacto]) VALUES (1, N'Alejandra', N'Barrachicna', CAST(0x00007F8900000000 AS DateTime), N'Femenino  ', 3)
INSERT [dbo].[PersonaFisicas] ([CodigoPersonaFisica], [Nombre], [Apellido], [FechaNacimiento], [Sexo], [CodigoContacto]) VALUES (2, N'Federico', N'Lamas', CAST(0x000088CB00000000 AS DateTime), N'Masculino ', 3)
INSERT [dbo].[PersonaFisicas] ([CodigoPersonaFisica], [Nombre], [Apellido], [FechaNacimiento], [Sexo], [CodigoContacto]) VALUES (3, N'Pedro', N'Rama', CAST(0x00007FB300000000 AS DateTime), N'Masculino ', 4)
INSERT [dbo].[PersonaFisicas] ([CodigoPersonaFisica], [Nombre], [Apellido], [FechaNacimiento], [Sexo], [CodigoContacto]) VALUES (4, N'Maria Julia', N'Mansilla', CAST(0x0000485D00000000 AS DateTime), N'Femenino  ', 1)
INSERT [dbo].[PersonaFisicas] ([CodigoPersonaFisica], [Nombre], [Apellido], [FechaNacimiento], [Sexo], [CodigoContacto]) VALUES (5, N'Adriana', N'Cabrera', CAST(0x000055CC00000000 AS DateTime), N'Femenino  ', 2)
/****** Object:  Table [dbo].[Empleados]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[Empleados](
	...
	[CodigoInformacionPersonal] [int] NOT NULL,
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Empleados] ([CodigoEmpleado], [Cargo], [CodigoInformacionPersonal], [CodigoUsuario], [Estado]) VALUES (1, N'Vendedor', 2, 2, 1)
INSERT [dbo].[Empleados] ([CodigoEmpleado], [Cargo], [CodigoInformacionPersonal], [CodigoUsuario], [Estado]) VALUES (2, N'Administrador', 1, 1, 1)
/****** Object:  Table [dbo].[Clientes]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Clientes](
	[Codigo] [int] NOT NULL,
	[CodigoInformacionPersonal] [int] NULL,
	[CodigoCuentaCorriente] [int] NOT NULL,
	[CodigoDescuento] [int] NOT NULL,
	[Estado] [bit] NULL,
...
GO
INSERT [dbo].[Clientes] ([Codigo], [CodigoInformacionPersonal], [CodigoCuentaCorriente], [CodigoDescuento], [Estado]) VALUES (1, 3, 1, 1, 1)
INSERT [dbo].[Clientes] ([Codigo], [CodigoInformacionPersonal], [CodigoCuentaCorriente], [CodigoDescuento], [Estado]) VALUES (2, 5, 2, 1, 1)
INSERT [dbo].[Clientes] ([Codigo], [CodigoInformacionPersonal], [CodigoCuentaCorriente], [CodigoDescuento], [Estado]) VALUES (3, 4, 3, 2, 1)
/****** Object:  Table [dbo].[Proveedores]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Proveedores](
	...
	[CodigoInformacionEmpresa] [int] NULL,
...
GO
INSERT [dbo].[Proveedores] ([CodigoProveedor], [CodigoInformacionEmpresa], [CodigoCondicionIVA], [Estado]) VALUES (1, 1, 1, 1)
INSERT [dbo].[Proveedores] ([CodigoProveedor], [CodigoInformacionEmpresa], [CodigoCondicionIVA], [Estado]) VALUES (2, 2, 1, 1)
INSERT [dbo].[Proveedores] ([CodigoProveedor], [CodigoInformacionEmpresa], [CodigoCondicionIVA], [Estado]) VALUES (3, 2, 2, 1)
/****** Object:  Table [dbo].[ProveedorXImpuesto]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Productos]    Script Date: 05/14/2019 16:10:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[Productos](
	...
	[PrecioCostoLista] [decimal](18, 0) NOT NULL,
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Productos] ([Codigo], [CodigoBulto], [Nombre], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (1, 10, N'Milka x 300 grs Leche', 6, 12, 24, CAST(50 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(100 AS Decimal(18, 0)), CAST(90 AS Decimal(18, 0)), 12, 1, 1, 1)
INSERT [dbo].[Productos] ([Codigo], [CodigoBulto], [Nombre], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (2, 20, N'Millk x 50 grs Combinado', 6, 12, 12, CAST(25 AS Decimal(18, 0)), CAST(35 AS Decimal(18, 0)), CAST(50 AS Decimal(18, 0)), CAST(35 AS Decimal(18, 0)), 12, 1, 1, 1)
/****** Object:  Default [DF__Clientes__Estado__1ED998B2]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Clientes] ADD  CONSTRAINT [DF__Clientes__Estado__1ED998B2]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Condicion__Estad__1CF15040]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[CondicionesIVA] ADD  CONSTRAINT [DF__Condicion__Estad__1CF15040]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__CuentaCor__Saldo__1920BF5C]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[CuentaCorrientes] ADD  CONSTRAINT [DF__CuentaCor__Saldo__1920BF5C]  DEFAULT ((0)) FOR [Saldo]
GO
/****** Object:  Default [DF__CuentaCor__Limit__1A14E395]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[CuentaCorrientes] ADD  CONSTRAINT [DF__CuentaCor__Limit__1A14E395]  DEFAULT ((2000)) FOR [LimiteCuenta]
GO
/****** Object:  Default [DF__Descuento__Estad__0425A276]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Descuentos] ADD  CONSTRAINT [DF__Descuento__Estad__0425A276]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Empleados__Estad__145C0A3F]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Empleados] ADD  CONSTRAINT [DF__Empleados__Estad__145C0A3F]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__FormasPag__Estad__1273C1CD]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[FormasPago] ADD  CONSTRAINT [DF__FormasPag__Estad__1273C1CD]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Impuestos__Estad__108B795B]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Impuestos] ADD  CONSTRAINT [DF__Impuestos__Estad__108B795B]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Productos__Estad__7E6CC920]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Productos] ADD  CONSTRAINT [DF__Productos__Estad__7E6CC920]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Proveedor__Estad__0BC6C43E]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Proveedores] ADD  CONSTRAINT [DF__Proveedor__Estad__0BC6C43E]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Rubros__Estado__09DE7BCC]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Rubros] ADD  CONSTRAINT [DF__Rubros__Estado__09DE7BCC]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Sectores__Estado__07F6335A]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Sectores] ADD  CONSTRAINT [DF__Sectores__Estado__07F6335A]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__TipoProdu__Estad__023D5A04]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[TipoProductos] ADD  CONSTRAINT [DF__TipoProdu__Estad__023D5A04]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Usuarios__Estado__00551192]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Usuarios] ADD  CONSTRAINT [DF__Usuarios__Estado__00551192]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  ForeignKey [FK_Clientes_CuentaCorrientes]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Clientes_Descuentos]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Clientes_PersonaFisicas1]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Clientes]  WITH CHECK ADD  CONSTRAINT [FK_Clientes_PersonaFisicas1] FOREIGN KEY([CodigoInformacionPersonal])
REFERENCES [dbo].[PersonaFisicas] ([CodigoPersonaFisica])
GO
ALTER TABLE [dbo].[Clientes] CHECK CONSTRAINT [FK_Clientes_PersonaFisicas1]
GO
/****** Object:  ForeignKey [FK_Contactos_Direcciones]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Empleados_PersonaFisicas]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Empleados]  WITH CHECK ADD  CONSTRAINT [FK_Empleados_PersonaFisicas] FOREIGN KEY([CodigoInformacionPersonal])
REFERENCES [dbo].[PersonaFisicas] ([CodigoPersonaFisica])
GO
ALTER TABLE [dbo].[Empleados] CHECK CONSTRAINT [FK_Empleados_PersonaFisicas]
GO
/****** Object:  ForeignKey [FK_Empleados_Usuarios]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_PersonaFisicas_Contactos]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[PersonaFisicas]  WITH CHECK ADD  CONSTRAINT [FK_PersonaFisicas_Contactos] FOREIGN KEY([CodigoContacto])
REFERENCES [dbo].[Contactos] ([CodigoContacto])
GO
ALTER TABLE [dbo].[PersonaFisicas] CHECK CONSTRAINT [FK_PersonaFisicas_Contactos]
GO
/****** Object:  ForeignKey [FK_PersonaJuridicas_Contactos]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[PersonaJuridicas]  WITH CHECK ADD  CONSTRAINT [FK_PersonaJuridicas_Contactos] FOREIGN KEY([CodigoContacto])
REFERENCES [dbo].[Contactos] ([CodigoContacto])
GO
ALTER TABLE [dbo].[PersonaJuridicas] CHECK CONSTRAINT [FK_PersonaJuridicas_Contactos]
GO
/****** Object:  ForeignKey [FK_Productos_Proveedores]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_Rubros]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_TipoProductos]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Proveedores_CondicionesIVA]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Proveedores_PersonaJuridicas]    Script Date: 05/14/2019 16:10:50 ******/
ALTER TABLE [dbo].[Proveedores]  WITH CHECK ADD  CONSTRAINT [FK_Proveedores_PersonaJuridicas] FOREIGN KEY([CodigoInformacionEmpresa])
REFERENCES [dbo].[PersonaJuridicas] ([CodigoPersonaJuridica])
GO
ALTER TABLE [dbo].[Proveedores] CHECK CONSTRAINT [FK_Proveedores_PersonaJuridicas]
GO
/****** Object:  ForeignKey [FK_ProveedorXImpuesto_Impuestos]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_ProveedorXImpuesto_Proveedores]    Script Date: 05/14/2019 16:10:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Usuarios_Sectores]    Script Date: 05/14/2019 16:10:50 ******/
