USE [BARRACHINA_DB]
GO
/****** Object:  Table [dbo].[MotivosDevolucion]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Impuestos]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[FormasPago]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Direcciones]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Direcciones] ([CodigoDireccion], [Calle], [Numero], [CodigoPostal], [Localidad], [Provincia]) VALUES (2, N'23', 5465, 7607, N'Buenos Aires', N'Miramar')
INSERT [dbo].[Direcciones] ([CodigoDireccion], [Calle], [Numero], [CodigoPostal], [Localidad], [Provincia]) VALUES (3, N'maipu', 2045, 44, N'Aires', N'Buenos')
SET IDENTITY_INSERT [dbo].[Direcciones] OFF
/****** Object:  Table [dbo].[Descuentos]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[CuentaCorrientes]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Contactos]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Contactos] ([CodigoContacto], [Telefono], [Celular], [Mail], [CodigoDireccion]) VALUES (2, N'22914578579', N'22914654654', N'distribuidorapiantoni@gmail.com', 0)
INSERT [dbo].[Contactos] ([CodigoContacto], [Telefono], [Celular], [Mail], [CodigoDireccion]) VALUES (3, N'2291', N'4654565', N'mraina@gmail.com', 0)
SET IDENTITY_INSERT [dbo].[Contactos] OFF
/****** Object:  Table [dbo].[CondicionesIVA]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[TipoProductos]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Sectores]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Rubros]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Proveedores]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Proveedores] ([CodigoProveedor], [RazonSocial], [NumeroCUIT], [NombreFantasia], [CodigoCondicionIVA], [CodigoContacto], [Estado]) VALUES (2000, N'Marcelo Lopez', N'2798465468', N'Piantoni', 1, N'2         ', 1)
/****** Object:  Table [dbo].[Usuarios]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Productos]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [Nombre], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (4, 40, N'Beldent menta suave', 4, 0, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), 20, 1000, 1, 1)
...
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [Nombre], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (6, 60, N'Beldent mix frutal', 4, 0, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), 20, 1000, 1, 1)
...
INSERT [dbo].[Productos] ([CodigoProducto], [CodigoBulto], [Nombre], [CodigoTipoProducto], [Stock], [StockCritico], [PrecioCosto], [PrecioCostoLista], [PrecioVentaMinorista], [PrecioVentaMayorista], [CantidadxBulto], [CodigoProveedor], [CodigoRubro], [Estado]) VALUES (8, 80, N'Beldent mentol', 4, 0, 20, CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)), 20, 1000, 1, 1)
/****** Object:  Table [dbo].[ProveedorXImpuesto]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Clientes]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[Clientes] ([CodigoCliente], [Nombre], [Apellido], [CodigoCuentaCorriente], [CodigoDescuento], [CodigoContacto], [Estado]) VALUES (5000, N'marina', N'mansilla', 1, 1, NULL, 1)
/****** Object:  Table [dbo].[Empleados]    Script Date: 05/17/2019 15:56:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Default [DF__Clientes__Estado__1ED998B2]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Clientes] ADD  CONSTRAINT [DF__Clientes__Estado__1ED998B2]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Condicion__Estad__49C3F6B7]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[CondicionesIVA] ADD  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__CuentaCor__Saldo__1920BF5C]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[CuentaCorrientes] ADD  CONSTRAINT [DF__CuentaCor__Saldo__1920BF5C]  DEFAULT ((0)) FOR [Saldo]
GO
/****** Object:  Default [DF__CuentaCor__Limit__1A14E395]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[CuentaCorrientes] ADD  CONSTRAINT [DF__CuentaCor__Limit__1A14E395]  DEFAULT ((2000)) FOR [LimiteCuenta]
GO
/****** Object:  Default [DF__Descuento__Estad__0425A276]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Descuentos] ADD  CONSTRAINT [DF__Descuento__Estad__0425A276]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Empleados__Estad__145C0A3F]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Empleados] ADD  CONSTRAINT [DF__Empleados__Estad__145C0A3F]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__FormasPag__Estad__1273C1CD]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[FormasPago] ADD  CONSTRAINT [DF__FormasPag__Estad__1273C1CD]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Impuestos__Estad__108B795B]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Impuestos] ADD  CONSTRAINT [DF__Impuestos__Estad__108B795B]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Productos__Stock__24927208]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((0)) FOR [Stock]
GO
/****** Object:  Default [DF__Productos__Preci__25869641]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((0)) FOR [PrecioCosto]
GO
/****** Object:  Default [DF__Productos__Preci__267ABA7A]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((0)) FOR [PrecioCostoLista]
GO
/****** Object:  Default [DF__Productos__Preci__276EDEB3]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((0)) FOR [PrecioVentaMinorista]
GO
/****** Object:  Default [DF__Productos__Preci__286302EC]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((0)) FOR [PrecioVentaMayorista]
GO
/****** Object:  Default [DF__Productos__Estad__29572725]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Productos] ADD  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Proveedor__Estad__0BC6C43E]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Proveedores] ADD  CONSTRAINT [DF__Proveedor__Estad__0BC6C43E]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Rubros__Estado__09DE7BCC]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Rubros] ADD  CONSTRAINT [DF__Rubros__Estado__09DE7BCC]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Sectores__Estado__07F6335A]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Sectores] ADD  CONSTRAINT [DF__Sectores__Estado__07F6335A]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__TipoProdu__Estad__023D5A04]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[TipoProductos] ADD  CONSTRAINT [DF__TipoProdu__Estad__023D5A04]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  Default [DF__Usuarios__Estado__00551192]    Script Date: 05/17/2019 15:56:45 ******/
ALTER TABLE [dbo].[Usuarios] ADD  CONSTRAINT [DF__Usuarios__Estado__00551192]  DEFAULT ((1)) FOR [Estado]
GO
/****** Object:  ForeignKey [FK_Clientes_Descuentos]    Script Date: 05/17/2019 15:56:45 ******/
...
GO
/****** Object:  ForeignKey [FK_Empleados_Usuarios]    Script Date: 05/17/2019 15:56:45 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_Rubros]    Script Date: 05/17/2019 15:56:45 ******/
...
GO
/****** Object:  ForeignKey [FK_Productos_TipoProductos]    Script Date: 05/17/2019 15:56:45 ******/
...
GO
/****** Object:  ForeignKey [FK_ProveedorXImpuesto_Impuestos]    Script Date: 05/17/2019 15:56:45 ******/
...
GO
/****** Object:  ForeignKey [FK_Usuarios_Sectores]    Script Date: 05/17/2019 15:56:45 ******/
